...
struct_img0 = intensity_normalization(
    struct_img0, scaling_param=intensity_scaling_param
)
struct_img1 = intensity_normalization(
    struct_img1, scaling_param=intensity_scaling_param
)
...
minArea = (
    5 * (1000**2) / (pixel_size_in_nano**2) * (downsample_percentage**2) / (100**2)
)
