...
masks, flows, styles = models.CellposeModel(model_type="tissuenet_cp3", gpu=True).eval(
    im, diameter=0, channels=[0, 0]
)
...
###masksnuc = masksnuc[0]
masksnuc, flows, styles = models.CellposeModel(model_type="tissuenet_cp3").eval(
    im2, diameter=0
)
